    ...
    <div id="app">
        <header>
            <div class="header">
                <!-- 1.block -->
                <div class="space">
                    <div v-if="!currentUserActive">
                        <button type="button" @click="checkreg = !checkreg" class="btn btn-outline-light">Registrieren</button>
                    </div>
                ...
                <!-- 3.block -->
                <div class="loginsection flex-fill" v-if="!currentUserActive">
                    <form class="formlogin" action="" method="POST" id="userpwform">
            ...
            <div class="content">
                <div class="search" v-if="tab === 'search'">
                    ...
                    <div class="movies">
                        ...
                        <div class="movie" id="movieid" v-if="getMovies.length > 0 && checkreg == false">
